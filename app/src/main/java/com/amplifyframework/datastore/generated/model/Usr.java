...
public final class Usr implements Model {
  ...
  public static final QueryField NEWS = field("Usr", "news");
  ...
  private final @ModelField(targetType="Person") List<Person> following;
  private final @ModelField(targetType="String") String news;
  public String getId() {
      return id;
  }
  ...
  private Usr(String id, String username, String fullname, String email, String pfp, String bio, List<String> followers, List<Person> following, String news) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), usr.getId()) &&
              ...
              ObjectsCompat.equals(getNews(), usr.getNews());
      }
  }
  ...
  @Override
   public String toString() {
    return new StringBuilder()
      ...
      .append("news=" + String.valueOf(getNews()))
      .append("}")
      .toString();
  }
  ...
  public interface BuildStep {
    ...
    BuildStep following(List<Person> following);
  ...
  public static class Builder implements UsernameStep, FullnameStep, EmailStep, BuildStep {
    ...
    private Builder(String id, String username, String fullname, String email, String pfp, String bio, List<String> followers, List<Person> following, String news) {
      this.id = id;
      this.username = username;
      this.fullname = fullname;
      this.email = email;
    ...
    @Override
     public BuildStep following(List<Person> following) {
        this.following = following;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String username, String fullname, String email, String pfp, String bio, List<String> followers, List<Person> following, String news) {
      super(id, username, fullname, email, pfp, bio, followers, following, news);
      Objects.requireNonNull(username);
      Objects.requireNonNull(fullname);
      Objects.requireNonNull(email);
    }
    ...
    @Override
     public CopyOfBuilder following(List<Person> following) {
